...
from data_handler import get_kermany_datasets, get_srinivasan_datasets, get_oct500_datasets, \
    get_datasets_full_classes
...
if __name__ == "__main__":
    ...
    total = len(kermany_dataset) + len(srinivasan_dataset) + len(oct500_dataset)
    np.save('avg_hist.npy', ((len(oct500_dataset)*hist_group3+len(srinivasan_dataset)*hist_group2+len(kermany_dataset)*hist_group1)/total))
