...
class SimMimWrapper(pl.LightningModule):
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.AdamW(self.model.parameters(), eps=1e-8, lr=self.lr, weight_decay=self.wd,
                                      betas=(0.9, 0.999))
        # scheduler = lr_scheduler.CosineAnnealingLR(optimizer, T_max=self.lr, eta_min=self.lr * 1e-3)
    ...
    #     img, lbl = batch
    #     loss, pred, mask = self.forward(img)
    #     self.step_output["test"].append(loss)
    #     return loss
